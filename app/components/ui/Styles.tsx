...
const H3Style = "text-[#fc0303] md:text-lg 2xl:text-xl mb-12 my-4";

const H2Style = "text-[3rem] md:text-[4rem] 2xl:text-[5rem] h2-shade";
...
export { Buttons, H3Style, H2Style, Load, Done };
